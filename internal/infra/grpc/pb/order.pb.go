...
func (x *ListOrders) GetOrders() []*Order {
	if x != nil {
		return x.Orders
	}
	return nil
...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\tGetOrders\x12\t.pb.Empty\x1a\x0e.pb.ListOrdersB\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	1, // 0: pb.ListOrders.orders:type_name -> pb.Order
	3, // 1: pb.OrderService.CreateOrder:input_type -> pb.CreateOrderRequest
	0, // 2: pb.OrderService.GetOrders:input_type -> pb.Empty
	1, // 3: pb.OrderService.CreateOrder:output_type -> pb.Order
	2, // 4: pb.OrderService.GetOrders:output_type -> pb.ListOrders
